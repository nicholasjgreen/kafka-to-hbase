...
class ArchiveAwsS3ServiceTest : StringSpec() {
    ...
    private fun hbasePayloads(): List<HbasePayload>
            = (1..100).map { index ->
                ...
                HbasePayload(Bytes.toBytes("key-$index"), messageBody(index).toByteArray(), "testId1", payloadTime(index), "_lastModifiedDateTime", "2020-01-01T00:00:00.000", consumerRecord, 1000L)
            }
