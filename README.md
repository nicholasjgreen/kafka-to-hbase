...
| K2HB_HBASE_BYPASS                         | WARNING! For specific purposes only. When set to 'true' this will prevent all records from being written into HBase! This is currently an extremely unusual mode of operations and is used for exploratory purposes only |                                                                                                                                                          
