...
| K2HB_KAFKA_FETCH_MIN_BYTES                | The minimum amount of data the server should return for a fetch request.                                                                                                                                                                             |
| K2HB_MAX_WAIT_MS                          | The maximum amount of time the server will block before answering the fetch request if there isn't sufficient data to immediately satisfy the requirement given by fetch.min.bytes.                                                                  |